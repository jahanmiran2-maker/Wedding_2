...
import { ArrowDown, Calendar, MapPin, Heart, Mail } from 'lucide-react';
        ...
        >
          ...
          >
            <button 
              ...
              className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-10 py-4 rounded-full font-sans font-bold text-xs tracking-[0.3em] uppercase hover:bg-white hover:text-[#8e735b] transition-all duration-500"
            >
              Enter the Album
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button 
                ...
                className="bg-[#c5a059] text-white px-12 py-4 rounded-full font-sans font-bold text-xs tracking-[0.3em] uppercase hover:bg-[#a68b6d] transition-all shadow-lg shadow-[#c5a059]/20"
              >
                View Full Gallery
              </button>
